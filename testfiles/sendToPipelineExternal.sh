...
# curl -i -X POST -H "Content-Type: multipart/form-data" -F "input=@$PWD/datapackage.jsonld.bkp1.bkp" "http://eis-openbudgets.iais.fraunhofer.de/linkedpipes/execute/fdp2rdf"